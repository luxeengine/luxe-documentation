...
In part 1, we'll be making something that looks like this: 
...
:::caution[Remember!]
Luxe data blocks have special rules and can't use normal Wren objects!
...
Then we can make a `reset_grid` function, adding it to our `System` class.
...
We'll add the `swap(...)` code, and uncomment the swap line we just added above.
...
Now uncomment the swap part in tick:
...
<Video src="/video/tutorials/match3/matches.mp4" />
...
<Video src="/video/tutorials/match3/process_matches.mp4" />
...
<Video src="/video/tutorials/match3/dropping_blocks.mp4" />
...
<Video src="/video/tutorials/match3/filling_blocks.mp4" />
...
<Video src="/video/tutorials/match3/cascading_changes.mp4" />
