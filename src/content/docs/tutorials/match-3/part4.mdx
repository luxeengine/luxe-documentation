...
import PublicImg from '@/components/PublicImg.astro';
...
<Video src="/video/tutorials/match3/grid.noshapes.mp4" />
...
<PublicImg src="/images/tutorials/match3/star.png"/>

---
Circle - [Download](/images/tutorials/match3/circle.png):
<PublicImg src="/images/tutorials/match3/circle.png"/>

--- 
Triangle - [Download](/images/tutorials/match3/triangle.png): 
<PublicImg src="/images/tutorials/match3/triangle.png"/>

--- 
Square - [Download](/images/tutorials/match3/square.png):
<PublicImg src="/images/tutorials/match3/square.png"/>

--- 
Pentagon - [Download](/images/tutorials/match3/pentagon.png):
<PublicImg src="/images/tutorials/match3/pentagon.png"/>

--- 
Hexagon - [Download](/images/tutorials/match3/hexagon.png):
<PublicImg src="/images/tutorials/match3/hexagon.png"/>
...
<Video src="/video/tutorials/match3/sprite.animate.mp4" />
...
<Video src="/video/tutorials/match3/grid.sprites.mp4" />
...
<Video src="/video/tutorials/match3/grid.sprites.1.mp4" />
...
<Video src="/video/tutorials/match3/grid.withshapes.mp4" />
...
<Video src="/video/tutorials/match3/world.rate.slow.mp4" />

Here's how it looks sped up to 4x speed (`F` key):

<Video src="/video/tutorials/match3/world.rate.fast.mp4" />
